...
class MapsViewModel(application: Application): AndroidViewModel(application= application){
    ...
    fun createNavigation(userId:String, idMarker:String, jarak: String, durationRemaining:String, startStreetName:String, context: Context){
       viewModelScope.launch {
           try {
        ...
        return try {
            ...
            if (querySnapshot != null && !querySnapshot.isEmpty) {
                querySnapshot.documents.map { document ->
                    ...
                    val startStreetName = document.getString("startStreetName") ?: ""
